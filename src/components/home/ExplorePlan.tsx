      ...
      <Container>
        ...
        <div className="relative ">
          <div className=" grid-cols-1 lg:grid-cols-2 relative z-[1] gap-10 grid justify-center max-w-[800px] mx-auto">
            <div style={{ willChange: 'transform, filter' }} className="h-full  hover:transition-all hover:duration-300  pricing-card  hover:translate-y-2 group no-hover hover:shadow-btn hover:shadow-primary-btn/30 bg-white border rounded-2xl w-full border-black/10">
              <div className="lg:px-10 px-8 pt-8 lg:pt-10 pb-4 border-b border-black/10">
                <h3 className=" text-2xl lg:text-3xl pb-px font-semibold ">Free</h3>
                <p>Try Copybot </p>
                ...
                <div className=" pb-4 mt-8 lg:mt-14">
                  <button className="w-full py-2 lg:py-2.5 rounded-lg border font-medium cursor-pointer border-black/40 ">
                    Stay on Free Plan
                  </button>
                </div>
              </div>
            ...
            <div style={{ willChange: 'transform, filter' }}  className="h-full no-hover hover:transition-all hover:duration-300 pricing-card  bg-white border hover:translate-y-2 group hover:shadow-btn hover:shadow-primary-btn/30 rounded-2xl w-full border-black/10">
              <div className="lg:px-10 px-8 pt-8 lg:pt-10 pb-4 border-b border-black/10">
                <h3 className="lg:text-3xl text-2xl pb-px font-semibold ">Pro</h3>
